...
// tích hợp chức năng search 
// Đây là nơi định nghĩa điều kiện đằng sau where
// implements Specification<Account> vì class này sẽ định nghĩa ra các điều kiện tìm kiếm
public class AccountSpecification implements Specification<Account> {
	...
	public AccountSpecification(String field, String operator, Object value) {
		super();
		this.field = field; // sau chữ where
		this.operator = operator; // đây là toán tử(like,......)
		this.value = value;
	}
